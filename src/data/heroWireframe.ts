...
export const WIRE = {
  ...
  offsetXRatio: 0.26,
  /**
   * Сдвиг ВНИЗ, доля от видимой высоты кадра. Нужен из-за панели параметров:
   * она висит в правом верхнем углу — ровно там, куда фигура переехала.
   * Без сдвига панель накрывала 213 px по вертикали из 494 (замер 1280×800),
   * со сдвигом — 117. Совсем развести их нельзя: фигура вдвое выше панели,
   * а первый экран не резиновый. Панель поэтому непрозрачная — см. её плашку
   * в `WireframeHeroCanvas`.
   */
  offsetYRatio: -0.09,
  scaleRatio: 0.21,
